...
class htmails_ss:    
    ...
    def get_mail_keywords(self):
        """Gets the keywords that are supported"""
    ...
    def get_seconds_wait(self):
        """Gets the seconds to wait, and defaults to 10"""
    ...
    def get_fields(self):
        """Gets the fields in HT-Mails.  These contain the data that is needed
        to send the HT-Mail"""
